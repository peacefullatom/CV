...
export const EXPERIENCES: Experience[] = [
    {
        ...
        description: [
            'Development & support of corporate solution used in BI and analytics,',
            'resolving defects found by testers/customers. Development of mobile client on React Native and Redux.'
        ].join(' ')
    },
    {
        ...
        description: [
            'Database developer: MS SQL Server 2012. Administrator of mail server.',
            'Various tasks of business automation: automated reports generation, reminders system',
            '(based on DB and mail server, with web interface) etc. Development and support of CRM.'
        ].join(' ')
    },
    {
        role: 'IPTV engineer',
        ...
        description: [
            ...
            'Main tasks were: initial hardware installation, support of system during Olympic games,',
            'dismantle of hardware upon event completion, resolving of issues connected with work of system',
            'in Bolshoy Ice Dome. Also worked as guide and interpreter for English speaking guests in free',
            'time on my own initiative.'
        ].join(' ')
    },
    {
        role: 'Software Developer',
        ...
        description: [
            ...
            'Various tasks of business automation: automated reports generation,',
            'reminders system (based on DB and mail server, with web interface) etc.',
    ...
    },
    {
        ...
        description: [
            'Network administrator: Cisco, Huawei, etc. Mail server administrator.',
            'Administrator/developer of MS SQL 2008 database. Partly web developer.'
        ].join(' ')
    },
    {
        ...
        description: [
            'Development, management, upgrade of network, including VPNs, LANs in big buildings,',
            'joints of ISDN, ADSL, Fiber, Ethernet nets. Support of third party software running',
            'on Windows and Linux. Management of MS SQL Server 2005: database development, reports generation.'
        ].join(' ')
    }
];
...
export const EDUCATION: Education[] = [
    {
        ...
        location: LOCATION,
        description: [
            'Control of quality at all stages of product/service life cycle.',
            'Specialized in automation of quality control.',
            'Attended courses on market analysis, systems of tracking of product/service',
            'from development to end user distribution, databases, C/C++ courses, Object-oriented programming.'
        ].join(' ')
    },
    {
...
export const READINGS: Readings[] = [
    {
        ...
        description: [
            ...
            'Written in a very understandable manner, so, the course can be easily understood',
            'by novice, but also contains a lot of professional tips.'
        ].join(' ')
    },
    {
