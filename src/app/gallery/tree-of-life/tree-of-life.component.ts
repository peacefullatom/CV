...
const ENTRIES: Entry[] = [
  ...
  { icon: "fa-user-circle-o", month: 3, year: 2017, label: "Employed as software developer." },
  { private: true, icon: "fa-building-o", month: 10, year: 2016, label: "Bought my second apartment." },
  { icon: "fa-user-circle-o", month: 2, year: 2014, label: "Employed as software developer." },
  { icon: "fa-user-circle-o", month: 1, year: 2014, label: "Worked on Olympic Games." },
  { private: true, icon: "fa-child", month: 7, year: 2013, label: "My second and third sons were born (twins!)." },
  { icon: "fa-user-circle-o", month: 3, year: 2012, label: "Employed as software developer." },
  { private: true, icon: "fa-building-o", month: 9, year: 2011, label: "Bought my first apartment." },
  ...
  { icon: "fa-user-circle-o", month: 3, year: 2008, label: "Employed as network operations center engineer." },
  { private: true, icon: "fa-trophy", month: 7, year: 2008, label: "Got my driver's license." },
  { private: true, icon: "fa-diamond", month: 8, year: 2007, label: "Wedding!" },
  { private: true, icon: "fa-heart", month: 11, year: 2005, label: "Met my wife." },
  { icon: "fa-user-circle-o", month: 5, year: 2004, label: "Employed as network engineer." },
  { private: true, icon: "fa-university", month: 8, year: 2002, label: "Went for university." },
  { icon: "fa-user-circle-o", month: 4, year: 2001, label: "Employed as website seller." },
  { private: true, icon: "fa-usd", month: 6, year: 2000, label: "Earned first money as software developer." },
  { icon: "fa-user-circle-o", month: 9, year: 1999, label: "Employed as furniture assembler." },
  { private: true, icon: "fa-university", month: 8, year: 1999, label: "Went for college." },
  { icon: "fa-chain-broken", month: 7, year: 1998, label: "Black August - it's when russian ruble was divided by zero!" },
  { private: true, icon: "fa-desktop", month: 1, year: 1997, label: "Bought my first PC." },
  { icon: "fa-user-circle-o", month: 0, year: 1996, label: "Worked as loader." },
  { private: true, icon: "fa-plane", month: 3, year: 1995, label: "Went to London to learn English." },
  { icon: "fa-chain-broken", month: 7, year: 1991, label: "The Soviet Union collapsed!" },
